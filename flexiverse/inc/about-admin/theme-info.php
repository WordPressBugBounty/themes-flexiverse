...
function flexiverse_admin_plugin_notice() {
    if ( ! get_option( 'flexiverse_notice_dismissed_v2' ) || ( time() - get_option( 'flexiverse_notice_dismissed_v2' ) > 30 * MINUTE_IN_SECONDS ) ) {
...
function flexverse_dismiss_custom_notice() {
    update_option( 'flexiverse_notice_dismissed_v2', time() );
    wp_die();
}
